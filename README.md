# CSS-CSE11
-->u can assign one class to multiple elements,or
-->you can assign multiple classes to single element.
-->Font size:
    em:this unit is realtive to the font size of the parent element.
